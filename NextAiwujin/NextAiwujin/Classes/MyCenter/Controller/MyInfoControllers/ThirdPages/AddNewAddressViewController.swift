        ...
        <<< ButtonRow("saveButton"){
            $0.title = "保存"
                ...
                if errors.count != 0 {
                    ...
                    self.myCenterViewModel.requestAddAddress(acceptName: accept_name, province: province!, city: city ?? 0, area: area ?? 0, address: address, zip: zip, telphone: telphone, mobile: mobile, finishCallback: { msg in
                        if msg == ""{
                            //添加成功
