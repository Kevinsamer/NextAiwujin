...
class ChoseGoodsTypeAlert: UIView , UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate{
    ...
    init(frame: CGRect, andHeight height: CGFloat,vc:GoodViewController) {
        ...
        goodsInfo.closeButton.addTarget(self, action: #selector(hideView), for: UIControl.Event.touchUpInside)
        ...
        tableview = UITableView.init(frame: CGRect(x:0,y:0,width:kWidth,height:0), style: UITableView.Style.plain)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell == nil {
            cell = ChoosTypeTableViewCell.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: ID)
        }
