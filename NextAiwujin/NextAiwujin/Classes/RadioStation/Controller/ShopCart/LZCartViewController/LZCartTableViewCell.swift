...
class LZCartTableViewCell: UITableViewCell {
    ...
    func setupMainView() {
        ...
        selectButton.setImage(UIImage(named: "cart_selected_btn"), for: UIControl.State.selected)
        selectButton.setImage(UIImage(named: "cart_unSelect_btn"), for: UIControl.State())
        selectButton.addTarget(self, action: #selector(selectButtonClick), for: UIControl.Event.touchUpInside)
...
//        title.adjustsFontSizeToFitWidth = true
        ...
        addButton.setImage(UIImage(named: "cart_addBtn_nomal"), for: UIControl.State())
        ...
        cutButton.setImage(UIImage(named: "cart_cutBtn_nomal"), for: UIControl.State())
...
//        }
    ...
    func configCellDateWithModel(_ model: LZCartModel) {
        ...
        lzImageView.kf.setImage(with: URL.init(string: BASE_URL + model.image!), placeholder: UIImage.init(named: "loading"))
