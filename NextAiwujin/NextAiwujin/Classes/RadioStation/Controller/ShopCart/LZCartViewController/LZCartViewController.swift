...
//        self.emptyView()
    ...
    func setupTableView() {
        ...
        tableView?.snp.makeConstraints({ (make) in
            ...
            make.top.equalTo(self.view).offset(kLZNavigationBarHeight + 50)
    ...
    func setupNavBar() {
        ...
        leftButton.setImage(UIImage(named: "back_button"), for: UIControl.State())
    ...
    func priceString(_ price: String) -> NSMutableAttributedString {
        ...
        attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor.black, range: rang)
        attributedString.addAttribute(NSAttributedString.Key.font, value: UIFont.systemFont(ofSize: 16), range: rang)
