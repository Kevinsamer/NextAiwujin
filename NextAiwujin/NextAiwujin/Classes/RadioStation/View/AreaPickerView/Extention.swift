...
public extension UIImage{
    ...
    func addContent(content: String, frame: CGRect) -> UIImage{
        ...
        let dic = [NSAttributedString.Key.foregroundColor: UIColor.white,NSAttributedString.Key.font: UIFont.systemFont(ofSize: 40)]
...
extension UILabel{
    func ranged(range: NSRange, color: UIColor?, fontNumber: CGFloat?){
        ...
        if fontNumber != nil {
            str.addAttributes([NSAttributedString.Key.font: UIFont.systemFont(ofSize: fontNumber!)], range: range)
        }
...
extension UIViewController{
    ...
    func alert(message: String) {
        ...
        alc.addAction(UIAlertAction(title: "确定", style: UIAlertAction.Style.cancel, handler: nil))
    ...
    func alert(message: String, doneBlock: @escaping ((UIAlertAction)->()),cancleBlock: @escaping ((UIAlertAction)->())) {
        let alc = UIAlertController(title: message, message: nil, preferredStyle: UIAlertController.Style.alert)
        alc.addAction(UIAlertAction(title: "取消", style: UIAlertAction.Style.default, handler: cancleBlock))
        alc.addAction(UIAlertAction(title: "确定", style: UIAlertAction.Style.cancel, handler: doneBlock))
...
extension NSObject{
    func alert(message: String, doneBlock: @escaping ((UIAlertAction)->())) {
        let alc = UIAlertController(title: message, message: nil, preferredStyle: UIAlertController.Style.alert)
        alc.addAction(UIAlertAction(title: "取消", style: UIAlertAction.Style.default, handler: nil))
        alc.addAction(UIAlertAction(title: "确定", style: UIAlertAction.Style.cancel, handler: doneBlock))
